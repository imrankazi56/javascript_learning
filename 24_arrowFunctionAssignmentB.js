...
console.log("========== 1. Print only TCS Emp.Name & Emp. Company ============");
...
console.warn("========= 2. Print  only Finance Dep. & Emp.Name ============= ");
...
console.warn("========= 3. Print the name with start  R  Complete Details ============= ");
